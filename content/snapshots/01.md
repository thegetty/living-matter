...
{{< q-figure id="fig-1-4" class="pdf-float-top" >}}

{{< q-figure id="fig-1-5" class="pdf-float-top pdf-no-top-border" >}}

{{< q-figure id="fig-1-6" class="pdf-float-top" >}}
...
{{< q-figure id="fig-1-7" class="figure-border pdf-float-top" >}}

{{< q-figure id="fig-1-8" class="pdf-two-column pdf-float-top" >}}
...
In this line of work, Martínez Silva plays with encounters between physical properties of materials and their conceptual auras, willingly assuming the risk of accidents that accompany the passage of time. For this artist, such risks provide new paths—his strategies for documenting visual accounts of damage to the pieces and their material degradation correlate with their sociopolitical meanings. They have also led him into scientific research into materials, as in the case of his pieces in latex. Such research is still pending for his pieces in chocolate, exploring the improbability that gives life to the long lasting.[^1]
