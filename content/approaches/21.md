...
{{< q-figure-group id="fig-21-9a, fig-21-9b" grid="2" label="Figure 21.9" caption="Light microscope image of the cross section of a sample with Paraloid B-72." credit="Harald Fitzek" >}}

{{< q-figure-group id="fig-21-10a, fig-21-10b" grid="2" label="Figure 21.10" caption="Spectra of standards (starch, zein, and Paraloid B-72) and a bread sample obtained using Raman point measurements (positions 3 and 7 with Paraloid; positions 6 and 9 with no Paraloid)." credit="Harald Fitzek" >}}

The results of light microscopy were also confirmed using a sophisticated Raman-SEM technique ({Tarnowski and Morris 2001}). Two correlative Raman-SEM measurements of an unembedded part of the sample were performed. The SEM’s good depth of field was used to obtain reasonable images, and Raman point measurements were used to confirm the chemistry ([fig. 21.11](#fig-21-11)). The results obtained also showed the presence of droplets of Paraloid B-72 on the top of the bread.
