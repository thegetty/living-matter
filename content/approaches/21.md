...
{{< q-figure-group id="fig-21-6a, fig-21-6b" class="pdf-two-column" grid="2" label="Figure 21.6" caption="Samples consolidated with four different consolidants." credit="Mirta Pavić" >}}
...
{{< q-figure-group id="fig-21-8a, fig-21-8b" class="pdf-two-column" grid="2" label="Figure 21.8" caption="FTIR-ATR spectra of the untreated bread (red), original sample (green and black), and Paraloid B-72 (blue)." credit="Ivana Bačić" >}}
...
{{< q-figure-group id="fig-21-9a, fig-21-9b" class="pdf-two-column" grid="2" label="Figure 21.9" caption="Light microscope image of the cross section of a sample with Paraloid B-72." credit="Harald Fitzek" >}}

{{< q-figure-group id="fig-21-10a, fig-21-10b" class="pdf-two-column" grid="2" label="Figure 21.10" caption="Spectra of standards (starch, zein, and Paraloid B-72) and a bread sample obtained using Raman point measurements (positions 3 and 7 with Paraloid; positions 6 and 9 with no Paraloid)." credit="Harald Fitzek" >}}
