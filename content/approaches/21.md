...
FTIR-ATR was used to determine how homogeneously the consolidant had penetrated the bread samples. The obtained spectra for untreated bread (without any consolidant), samples taken from the original object consolidated with Paraloid B-72, and pure solution of Paraloid B-72 in ethanol are shown in [fig. 21.9](#fig-21-9) and [fig. 21.10](#fig-21-10). The line drawn at 1723 cm<sup>-1</sup> signals the absorption band related to carbonyl stretching (ν C=O) characteristic for Paraloid B-72. This band was used as a marker for determining the presence of Paraloid B-72 in the sample, since it is not present in untreated bread. In addition, the variations in intensity as a function of location provided semi-quantitative information on the concentration of Paraloid B-72. The significant variations in intensity indicate an uneven distribution of Paraloid B-72 ({{< q-cite "Vahur et al. 2016" >}}).
