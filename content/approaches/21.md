...
{{< q-figure id="fig-21-2" class="pdf-two-column pdf-float-bottom" >}}
...
{{< q-figure id="fig-21-3" class="pdf-float-top" >}}

{{< q-figure id="fig-21-4" class="pdf-float-top pdf-no-top-border" >}}

{{< q-figure id="fig-21-5" class="pdf-float-top" >}}
...
{{< q-figure id="fig-21-7" class="pdf-two-column" >}}
...
{{< q-figure-group id="fig-21-12a, fig-21-12b" class="pdf-two-column pdf-float-top pdf-no-top-border" grid="2" caption="Raman mapping of (a) sample Paraloid B-72 with reference spectra (b)." credit="Harald Fitzek" >}}
