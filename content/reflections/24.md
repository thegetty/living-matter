...
{{< q-figure id="fig-24-1" class="pdf-float-bottom pdf-no-bottom-border pdf-80-percent-width" >}}
...
{{< q-figure id="fig-24-4" class="pdf-no-top-border" >}}
...
{{< q-figure id="fig-24-5" class="pdf-float-top" >}}

{{< q-figure id="fig-24-6" class="pdf-float-top pdf-no-top-border" >}}

{{< q-figure id="fig-24-7" class="pdf-float-top pdf-no-top-border pdf-no-bottom-margin" >}}

{{< q-figure id="fig-24-8" class="pdf-float-top" >}}

{{< q-figure id="fig-24-9" class="pdf-float-top pdf-no-top-border" >}}
